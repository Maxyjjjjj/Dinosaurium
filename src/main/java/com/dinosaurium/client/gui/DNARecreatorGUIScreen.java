...
public class DNARecreatorGUIScreen extends AbstractContainerScreen<DNARecreatorGUIMenu> {
	private final static HashMap<String, Object> guistate = DNARecreatorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_recreate;

	public DNARecreatorGUIScreen(DNARecreatorGUIMenu container, Inventory inventory, Component text) {
