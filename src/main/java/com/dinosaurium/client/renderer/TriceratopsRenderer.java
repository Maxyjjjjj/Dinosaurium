...
import com.dinosaurium.entity.model.TriceratopsModel;
...
public class TriceratopsRenderer extends GeoEntityRenderer<TriceratopsEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TriceratopsEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
