...
import com.dinosaurium.entity.model.SpinosaurusModel;
...
public class SpinosaurusRenderer extends GeoEntityRenderer<SpinosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(SpinosaurusEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, SpinosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
