package com.dinosaurium.world.features;
...
import com.dinosaurium.world.features.configurations.StructureFeatureConfiguration;
import com.dinosaurium.DinosauriumMod;

public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, DinosauriumMod.MODID);
