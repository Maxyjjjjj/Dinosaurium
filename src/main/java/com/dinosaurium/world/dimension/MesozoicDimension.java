...
package com.dinosaurium.world.dimension;
...
public class MesozoicDimension {
	@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
	public static class MesozoicSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("dinosaurium:mesozoic"), customEffect);
		}
	}
}
