...
public class VelociraptorModel extends GeoModel<VelociraptorEntity> {
	...
	public ResourceLocation getAnimationResource(VelociraptorEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/velociraptor.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(VelociraptorEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/velociraptor.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(VelociraptorEntity animatable, long instanceId, AnimationState animationState) {
