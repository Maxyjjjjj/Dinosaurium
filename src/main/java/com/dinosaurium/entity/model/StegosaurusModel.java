...
public class StegosaurusModel extends GeoModel<StegosaurusEntity> {
	...
	public ResourceLocation getAnimationResource(StegosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/stegosaurus.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(StegosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/stegosaurus.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(StegosaurusEntity animatable, long instanceId, AnimationState animationState) {
