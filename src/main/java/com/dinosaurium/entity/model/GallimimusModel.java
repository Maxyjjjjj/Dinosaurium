...
public class GallimimusModel extends GeoModel<GallimimusEntity> {
	...
	public ResourceLocation getAnimationResource(GallimimusEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/gallimimus.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(GallimimusEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/gallimimus.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(GallimimusEntity animatable, long instanceId, AnimationState animationState) {
