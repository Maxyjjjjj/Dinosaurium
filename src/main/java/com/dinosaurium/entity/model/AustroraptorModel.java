...
public class AustroraptorModel extends GeoModel<AustroraptorEntity> {
	...
	public ResourceLocation getAnimationResource(AustroraptorEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/austroraptor.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(AustroraptorEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/austroraptor.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(AustroraptorEntity animatable, long instanceId, AnimationState animationState) {
