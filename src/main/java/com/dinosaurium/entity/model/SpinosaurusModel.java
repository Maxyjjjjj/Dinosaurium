...
public class SpinosaurusModel extends GeoModel<SpinosaurusEntity> {
	...
	public ResourceLocation getAnimationResource(SpinosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/spinosaurus.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SpinosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/spinosaurus.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(SpinosaurusEntity animatable, long instanceId, AnimationState animationState) {
