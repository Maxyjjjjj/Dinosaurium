...
public class PteranodonModel extends GeoModel<PteranodonEntity> {
	...
	public ResourceLocation getAnimationResource(PteranodonEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/pteranodon.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(PteranodonEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/pteranodon.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(PteranodonEntity animatable, long instanceId, AnimationState animationState) {
