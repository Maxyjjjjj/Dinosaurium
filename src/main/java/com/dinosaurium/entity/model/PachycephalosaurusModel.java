...
public class PachycephalosaurusModel extends GeoModel<PachycephalosaurusEntity> {
	...
	public ResourceLocation getAnimationResource(PachycephalosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/pachycephalosaurus.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(PachycephalosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/pachycephalosaurus.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(PachycephalosaurusEntity animatable, long instanceId, AnimationState animationState) {
