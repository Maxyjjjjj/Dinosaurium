...
public class OuranosaurusModel extends GeoModel<OuranosaurusEntity> {
	...
	public ResourceLocation getAnimationResource(OuranosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:animations/ouranosaurus.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OuranosaurusEntity entity) {
		return ResourceLocation.parse("dinosaurium:geo/ouranosaurus.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(OuranosaurusEntity animatable, long instanceId, AnimationState animationState) {
